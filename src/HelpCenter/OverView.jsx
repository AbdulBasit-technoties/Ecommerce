        ...
        <div className="container mx-auto 2xl:px-52 xl:px-20 lg:px-11 px-4 relative">
            ...
            <div className="container mx-auto 2xl:px-52 xl:px-20 lg:px-11 px-4 relative md:mt-24 mt-16">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 mt-8 gap-6">
                    <div className="flex">
                        <FiHelpCircle className="fea icon-ex-md text-orange me-3 size-5 mt-1"></FiHelpCircle>
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold">How our <span className="text-orange">Cartzio</span> work ?</h5>
                    ...
                    <div className="flex">
                        <FiHelpCircle className="fea icon-ex-md text-orange me-3 size-5 mt-1"></FiHelpCircle>
                        <div className="flex-1">
                            <h5 className="mb-2 text-xl font-semibold"> Is <span className="text-orange">Cartzio</span> safer to use with my account ?</h5>
