...
function Footer() {
    return (
        <Fragment>
            <footer className="footer bg-[#161c28] footer relative text-[#c6cad0] ">    
                        ...
                        <div className="py-[60px] px-0">
                            <div className="grid md:grid-cols-12 grid-cols-1 gap-6">
                                <div className="lg:col-span-3 md:col-span-12">
                                    ...
                                    <p className="mt-6 text-gray">Upgrade your style with our curated sets. Choose confidence, embrace your unique look.</p>
                                    <ul className="list-none mt-6">
                                        {footerSocial.map((item,index) =>{
                                            let Icon = item.icon
                                            return(
                                                <li className="inline" key={index}><Link to={item.link} target="_blank" className="size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-gray rounded-md hover:text-orange  text-slate-300"><Icon className="h-4 w-4 align-middle" title="Buy Now"></Icon></Link></li>
                                            )
                                        })}
                                    </ul>
                                </div>
                                ...
                                <div className="lg:col-span-6 md:col-span-12">
                                    <h5 className="tracking-[1px] text-gray font-semibold">Shopping & Clothes</h5>
                                        ...
                                        <div className="md:col-span-4">
                                            <ul className="list-none footer-list mt-6">
                                                {footerShopping1.map((item,index) =>{
                                                    return(
                                                        <li className="ms-0 mt-[10px]" key={index}><Link to="" className="text-gray hover:text-gray duration-500 ease-in-out"><i className="mdi mdi-chevron-right"></i> {item}</Link></li>
                                                    )
                                                })}
                                            </ul>
                                        </div>
                                        ...
                                        <div className="md:col-span-4">
                                            <ul className="list-none footer-list mt-6">
                                                {footerShopping3.map((item,index)=>{
                                                    return(
                                                        <li className="mt-[10px] ms-0" key={index}><Link to="" className="text-gray hover:text-gray duration-500 ease-in-out"><i className="mdi mdi-chevron-right"></i> {item}</Link></li>
                                                    )
                                                })}
                                            </ul>
                                        </div>
                                ...
                                <div className="lg:col-span-3 md:col-span-4">
                                    <h5 className="tracking-[1px] text-gray font-semibold">Newsletter</h5>
                                        ...
                                        <div className="grid grid-cols-1">
                                            <div className="my-3">
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    ...
                                                    <input type="email" className="ps-12 rounded w-full py-2 px-3 h-10 bg-[#1f2937] border-0 text-gray focus:shadow-none focus:ring-0 placeholder:text-gray outline-none" placeholder="Email" name="email" required=""/>
                                                </div>
                                            </div>
