...
function ForgotPassword() {
  return (
    <Fragment>
        <section className="md:h-screen py-36 flex items-center bg-orange/10  bg-[url('./assets/images/salr-bg.png')] bg-center bg-no-repeat bg-cover">
                            ...
                            <div className="p-8 lg:px-20">
                                ...
                                <form className="text-start lg:py-20 py-8">
                                    ...
                                    <div className="grid grid-cols-1">
                                        ...
                                        <div className="text-center">
                                            <span className="text-slate-400 me-2">Remember your password ? </span><Link to="/login" className="text-black  font-bold inline-block">Sign in</Link>
                                        </div>
                                    </div>
                                </form>
