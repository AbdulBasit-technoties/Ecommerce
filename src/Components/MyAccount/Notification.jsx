...
import {imageAssets} from '../../Helpers/images.js'
                        ...
                        <div className="rounded-md shadow  bg-white ">
                            ...
                            <div className="p-6">
                                <div className="flex justify-between pb-4">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-100  text-orange-500 focus:border-orange-300 focus:ring focus:ring-offset-0 focus:ring-orange-200 focus:ring-opacity-50" type="checkbox" value="" readOnly id="noti1"/>
                                ...
                                <div className="flex justify-between py-4 border-t border-gray-100 ">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-100  text-orange-500 focus:border-orange-300 focus:ring focus:ring-offset-0 focus:ring-orange-200 focus:ring-opacity-50" type="checkbox" value="" readOnly defaultChecked id="noti2"/>
                                ...
                                <div className="flex justify-between py-4 border-t border-gray-100 ">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-100  text-orange-500 focus:border-orange-300 focus:ring focus:ring-offset-0 focus:ring-orange-200 focus:ring-opacity-50" type="checkbox" value="" readOnly id="noti3"/>
                                ...
                                <div className="flex justify-between py-4 border-t border-gray-100 ">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-100  text-orange-500 focus:border-orange-300 focus:ring focus:ring-offset-0 focus:ring-orange-200 focus:ring-opacity-50" type="checkbox" value="" readOnly id="noti4"/>
                        ...
                        <div className="rounded-md shadow  bg-white  mt-6">
                            ...
                            <div className="p-6">
                                <div className="flex justify-between pb-4">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-100  text-orange-500 focus:border-orange-300 focus:ring focus:ring-offset-0 focus:ring-orange-200 focus:ring-opacity-50" type="checkbox" value="" readOnly id="noti5"/>
                                ...
                                <div className="flex justify-between py-4 border-t border-gray-100 ">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-100  text-orange-500 focus:border-orange-300 focus:ring focus:ring-offset-0 focus:ring-orange-200 focus:ring-opacity-50" type="checkbox" value="" readOnly id="noti6"/>
                                ...
                                <div className="flex justify-between py-4 border-t border-gray-100 ">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-100  text-orange-500 focus:border-orange-300 focus:ring focus:ring-offset-0 focus:ring-orange-200 focus:ring-opacity-50" type="checkbox" value="" readOnly defaultChecked id="noti7"/>
                                ...
                                <div className="flex justify-between py-4 border-t border-gray-100 ">
                                    ...
                                    <div className="">
                                        <input className="form-checkbox rounded border-gray-100  text-orange-500 focus:border-orange-300 focus:ring focus:ring-offset-0 focus:ring-orange-200 focus:ring-opacity-50" type="checkbox" value="" readOnly defaultChecked id="noti8"/>
