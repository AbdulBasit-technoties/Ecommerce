  ...
  return (
    <Fragment>
        ...
        <div className="lg:w-3/4 md:w-2/3 md:px-3 mt-6 md:mt-0">
                                ...
                                <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
                                    <div>
                                        ...
                                        <div className="form-icon relative mt-2">
                                            ...
                                            <input type="text" className="ps-12 w-full py-2 px-3 h-10 bg-transparent   rounded outline-none border border-gray-100  focus:ring-0" placeholder="First Name:" id="firstname" name="name" required=""/>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="form-icon relative mt-2">
                                            ...
                                            <input type="text" className="ps-12 w-full py-2 px-3 h-10 bg-transparent   rounded outline-none border border-gray-100  focus:ring-0" placeholder="Last Name:" id="lastname" name="name" required=""/>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="form-icon relative mt-2">
                                            ...
                                            <input type="email" className="ps-12 w-full py-2 px-3 h-10 bg-transparent   rounded outline-none border border-gray-100  focus:ring-0" placeholder="Email" name="email" required=""/>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="form-icon relative mt-2">
                                            ...
                                            <input name="name" id="occupation" type="text" className="ps-12 w-full py-2 px-3 h-10 bg-transparent   rounded outline-none border border-gray-100  focus:ring-0" placeholder="Occupation :"/>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="p-6 rounded-md shadow  bg-white  mt-6">
                            <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
                                <div>
                                        ...
                                        <div className="grid grid-cols-1 gap-5">
                                            <div>
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    ...
                                                    <input name="number" id="number" type="number" className="ps-12 w-full py-2 px-3 h-10 bg-transparent   rounded outline-none border border-gray-100  focus:ring-0" placeholder="Phone :"/>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    ...
                                                    <input name="url" id="url" type="url" className="ps-12 w-full py-2 px-3 h-10 bg-transparent   rounded outline-none border border-gray-100  focus:ring-0" placeholder="Url :"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 gap-5">
                                            <div>
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    ...
                                                    <input type="password" className="ps-12 w-full py-2 px-3 h-10 bg-transparent   rounded outline-none border border-gray-100  focus:ring-0" placeholder="Old password" required=""/>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    <FiKey className="w-4 h-4 absolute top-3 start-4"></FiKey>
                                                    <input type="password" className="ps-12 w-full py-2 px-3 h-10 bg-transparent   rounded outline-none border border-gray-100  focus:ring-0" placeholder="New password" required=""/>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    <FiKey className="w-4 h-4 absolute top-3 start-4"></FiKey>
                                                    <input type="password" className="ps-12 w-full py-2 px-3 h-10 bg-transparent   rounded outline-none border border-gray-100  focus:ring-0" placeholder="Re-type New password" required=""/>
                                                </div>
                                            </div>
                                        </div>
